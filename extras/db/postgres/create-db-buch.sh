...
# (3) chown postgres:postgres /var/lib/postgresql/tablespace/buch

# docker compose exec postgres bash /scripts/create-db-buch.sh
psql --dbname=postgres --username=postgres --file=/scripts/create-db-buch.sql
psql --dbname=postgres --username=postgres --file=/scripts/create-table-buch.sql
